...
counter = 1;
for i=1:num_len3
    if isnan(TADPOLE_V3{i}{1}.ravlt_immediate) || ...
        isnan(TADPOLE_V3{i}{2}.ravlt_immediate) || ...
        isnan(TADPOLE_V3{i}{3}.ravlt_immediate) || ...
        (TADPOLE_V3{i}{1}.ravlt_immediate) < 0 || ...
        (TADPOLE_V3{i}{2}.ravlt_immediate) < 0 || ...
        (TADPOLE_V3{i}{3}.ravlt_immediate) < 0
        continue
    else
...
for i=1:N
    for t=1:T
        ...
        Y(i, t, 1) = tadpole_i.ravlt_immediate;
...
save('RAVLT_AV45_AV45', 'X');
save('RAVLT_AV45_RAVLT', 'Y');
