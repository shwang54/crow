...
counter = 1;
for i=1:num_len3
    if isnan(TADPOLE_V3{i}{1}.mmse) || ...
        isnan(TADPOLE_V3{i}{2}.mmse) || ...
        isnan(TADPOLE_V3{i}{3}.mmse) || ...
        (TADPOLE_V3{i}{1}.mmse) == -1 || ...
        (TADPOLE_V3{i}{2}.mmse) == -1 || ...
        (TADPOLE_V3{i}{3}.mmse) == -1
        continue
    else
...
save('MMSE_AV45_AV45', 'X');
save('MMSE_AV45_MMSE', 'Y');
